...
import static com.jjbeto.microservice.cryptolocator.service.CoinDeskService.CACHE_COIN_PRICE;
...
public class CacheConfig {
    ...
    public CacheManager ehCacheManager() {
        ...
        var cacheForCoinPrice = newCacheConfigurationBuilder(String.class, PriceDataDto.class, resourcePools)
                .withExpiry(timeToLiveExpiration(ofSeconds(ttlInSec))).build();

        final Map<String, CacheConfiguration<?, ?>> caches = Map.of(
                CACHE_COIN_PRICE, cacheForCoinPrice
        );
